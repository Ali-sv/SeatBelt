...
Citizen.CreateThread(function()
    ...
    AddEventHandler("FakeRevive", function(inputText) 
        ...
        beltOn = not beltOn 
        if beltOn then 
		  TriggerEvent("pNotify:SendNotification", {text = "Kamar bande Shoma baste shod!", type = "success", timeout = 1400, layout = "centerLeft"})
		  ...
		  TriggerEvent("pNotify:SendNotification", {text = "Kamar bande Shoma baz shod!", type = "error", timeout = 1400, layout = "centerRight"})
...
Citizen.CreateThread(function()
 ...
 while true do
  ...
  TriggerEvent('InteractSound_CL:PlayOnOne','seatbeltalert', 0.5)
   Wait(20000)
  end
  Wait(5000)
 end
